...
public class TextureLoader {
    ...
    public void loadTexture( int texture_id, String filename, Boolean repeat ) throws IOException, InterruptedException {
    ...
    protected void setupTextureParameters(Boolean repeat) {
